 ...
 *
 * @method static array<string, mixed> send(array<string, mixed> $payload, string|null $idempotencyKey = null) Senkron mail gönderimi (POST /api/v1/email/send)
 * @method static array<string, mixed> sendAsync(array<string, mixed> $payload, string|null $idempotencyKey = null) Asenkron gönderim (POST /api/v1/email/send-async)
 * @method static array<string, mixed> sendTest(array<string, mixed> $payload, string|null $idempotencyKey = null) Dry-run test (POST /api/v1/email/send-test)
